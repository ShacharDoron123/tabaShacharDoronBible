<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="chapter3.aspx.cs" Inherits="tabaShacharDoronBible.chapter3" %>
...
יז וּלְאָדָם אָמַר, כִּי-שָׁמַעְתָּ לְקוֹל אִשְׁתֶּךָ, וַתֹּאכַל מִן-הָעֵץ, אֲשֶׁר צִוִּיתִיךָ לֵאמֹר לֹא תֹאכַל מִמֶּנּוּ--אֲרוּרָה הָאֲדָמָה, בַּעֲבוּרֶךָ, בְּעִצָּבוֹן תֹּאכְלֶנָּה, כֹּל יְמֵי חַיֶּיךָ.  יח וְקוֹץ וְדַרְדַּר, תַּצְמִיחַ לָךְ; וְאָכַלְתָּ, אֶת-עֵשֶׂב הַשָּׂדֶה.  יט בְּזֵעַת אַפֶּיךָ, תֹּאכַל לֶחֶם, עַד שׁוּבְךָ אֶל-הָאֲדָמָה, כִּי מִמֶּנָּה לֻקָּחְתָּ:  כִּי-עָפָר אַתָּה, וְאֶל-עָפָר תָּשׁוּב.  כ וַיִּקְרָא הָאָדָם שֵׁם אִשְׁתּוֹ, חַוָּה:  כִּי הִוא הָיְתָה, אֵם כָּל-חָי.  כא וַיַּעַשׂ יְהוָה אֱלֹהִים לְאָדָם וּלְאִשְׁתּוֹ, כָּתְנוֹת עוֹר--וַיַּלְבִּשֵׁם. 
כב וַיֹּאמֶר יְהוָה אֱלֹהִים, הֵן הָאָדָם הָיָה כְּאַחַד מִמֶּנּוּ, לָדַעַת, טוֹב וָרָע; וְעַתָּה פֶּן-יִשְׁלַח יָדוֹ, וְלָקַח גַּם מֵעֵץ הַחַיִּים, וְאָכַל, וָחַי לְעֹלָם.  כג וַיְשַׁלְּחֵהוּ יְהוָה אֱלֹהִים, מִגַּן-עֵדֶן--לַעֲבֹד, אֶת-הָאֲדָמָה, אֲשֶׁר לֻקַּח, מִשָּׁם.  כד וַיְגָרֶשׁ, אֶת-הָאָדָם; וַיַּשְׁכֵּן מִקֶּדֶם לְגַן-עֵדֶן אֶת-הַכְּרֻבִים, וְאֵת לַהַט הַחֶרֶב הַמִּתְהַפֶּכֶת, לִשְׁמֹר, אֶת-דֶּרֶךְ עֵץ הַחַיִּים. 

        </p>
    </div>
    <br />
    <button onclick="expandTextBox()">הרחב תיבה</button>
    <br />
    <br />
    <br />
    <br />
    <h2 class="right">יצירה:</h2>
    <img src="images/chapter_3.jpg" alt="בראת העולם" class="clickable-image" />
    <p>
        טיציאן (1570) "נפילתו של אדם". וריאציה על פיתוי ואובדן. כוריאוגרפיה של פיתול ונפילה. 
    </p>
    <h2 class="right">סרטון:</h2>
    <iframe width="600" height="350" 
            src="https://www.youtube.com/embed/SSk5FkTkIQc" 
    ...
    <br />
    <h2 class="right">מאמר:</h2>
       <iframe width="600" height="450"
        src="pdf/מאמר בראשית ג.pdf"
        title="pdf"
        frameborder="0"
        allowfullscreen>
</iframe>
    <br />
    <h2 class="right">כתיבה אישית:</h2>
           <iframe width="600" height="450"
        src="pdf/כתיבה אישית בראשית ג.pdf"
        title="pdf"
        frameborder="0"
        allowfullscreen>
</iframe>
